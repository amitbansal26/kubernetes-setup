...
# Log both stdout and stderr for troubleshooting kubeadm init issues
sudo kubeadm init --apiserver-advertise-address=172.16.16.100 --pod-network-cidr=20.96.0.0/12 | sudo tee /root/kubeinit.log
